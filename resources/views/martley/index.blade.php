        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="text-center">
              <img src="{{url('assets/img/illustrations/illustration-1.png')}}" alt="..." class="img-fluid mb-3" style="width: 200px;">
            </div>
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="card">
            ...
            <!-- Image -->
            <img src="{{url('martley_web_asset/assets/img/photos/photo-7.jpg')}}" alt="..." class="card-img-top">
      ...
      <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
          <div class="card">
            ...
            <!-- Image -->
            <img src="{{url('martley_web_asset/assets/img/photos/photo-21.jpg')}}" alt="..." class="card-img-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-light bg-white">
      <div class="container">
        ...
        <a class="navbar-brand" href="index-2.html">
          <img src="{{url('martley_web_asset/assets/img/brand.svg')}}" class="navbar-brand-img" alt="...">
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              <div class="dropdown-menu dropdown-menu-xl p-0" aria-labelledby="navbarLandings">
                <div class="row gx-0">
                  <div class="col-12 col-lg-6">
                    <div class="dropdown-img-start" style="background-image: url(martley_web_asset/assets/img/photos/photo-3.jpg);">
            ...
            <li class="nav-item dropdown">
              ...
              <ul class="dropdown-menu" aria-labelledby="navbarAccount">
                ...
                <li class="dropdown-item dropend">
                  ...
                  <div class="dropdown-menu">
                    <a class="dropdown-item" href="{{route('adminlogin_page')}}">
                      Side Cover
                    </a>
          ...
          <!-- Button -->
          <a class="navbar-btn btn btn-sm btn-primary lift ms-auto" style="background:#de2641" href="https://themes.getbootstrap.com/product/landkit/" target="_blank">
            Call Away
          </a>
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="{{url('martley_web_asset/assets/img/illustrations/illustration-2.png')}}" class="img-fluid mw-md-150 mw-lg-130 mb-6 mb-md-0" alt="..." data-aos="fade-up" data-aos-delay="100">
          ...
          <div class="col-12 col-md-7 col-lg-6 order-md-1" data-aos="fade-up">
            ...
            <h1 class="display-3 text-center text-md-start">
              Welcome to <span class="text-primary-text">Martley </span>Investment  <br>
               Service Limited
               <!-- <img src="{{url('martley_web_asset/4.jpeg')}}"/> -->
            </h1>
            

            <!-- Text -->
            <p class="lead text-center text-md-start text-muted mb-6 mb-lg-8">
            we render financial and investment adviser.
            </p>

            <!-- Buttons -->
            <div class="text-center text-md-start">
              <a href="overview.html" class="btn btn-primary shadow lift me-1" style="background:#de2641">
                Contact Us <i class="fe fe-arrow-right d-none d-md-inline ms-3"></i>
              </a>
        ...
        <div class="row align-items-center justify-content-between mb-8 mb-md-11">
          ...
          <div class="col-12 col-md-6 col-lg-5 order-md-1" data-aos="fade-right">
            ...
            <div class="card shadow-light-lg lift lift-lg">
              ...
              <!-- Image -->
              <img src="{{url('martley_web_asset/assets/img/photos/photo-2.jpg')}}" alt="..." class="card-img-top">
          ...
          <div class="col-12 col-md-5 col-lg-6">
            ...
            <div class="w-md-150 w-lg-130 position-relative" data-aos="fade-left">
              ...
              <div class="img-skewed img-skewed-start">
                ...
                <!-- Image -->
                <img src="{{url('martley_web_asset/assets/img/screenshots/desktop/dashkit.jpg')}}" class="screenshot img-fluid img-skewed-item" alt="...">
              ...
              <div class="row gx-0">
                <div class="col-12 col-md-6">
                  ...
                  <div class="card-img-slider" data-flickity='{"fade": true, "imagesLoaded": true, "pageDots": false, "prevNextButtons": false, "asNavFor": "#blogSlider", "draggable": false}'>
                    <a class="card-img-start w-100 bg-cover" style="background-image: url(martley_web_asset/assets/img/photos/photo-1.jpg);" href="#!">
      ...
      <div class="container">
        <div class="row align-items-center">
          <div class="col-12 col-md-5 col-lg-6 order-md-2">
            ...
            <!-- Image -->
            <img src="{{url('martley_web_asset/assets/img/illustrations/illustration-8.png')}}" alt="..." class="img-fluid mb-6 mb-md-0">
      ...
      <div class="container">
        <div class="row">
          <div class="col-12 col-md-4 col-lg-3">
            ...
            <!-- Brand -->
            <img src="{{url('martley_web_asset/assets/img/brand.svg')}}" alt="..." class="footer-brand img-fluid mb-2">
            ...
            <ul class="list-unstyled list-inline list-social mb-6 mb-md-0">
              <li class="list-inline-item list-social-item me-3">
                <a href="#!" class="text-decoration-none">
                  <img src="{{url('martley_web_asset/assets/img/icons/social/instagram.svg')}}" class="list-social-icon" alt="...">
                </a>
              </li>
              <li class="list-inline-item list-social-item me-3">
                <a href="#!" class="text-decoration-none">
                  <img src="{{url('martley_web_asset/assets/img/icons/social/facebook.svg')}}" class="list-social-icon" alt="...">
                </a>
              </li>
              <li class="list-inline-item list-social-item me-3">
                <a href="#!" class="text-decoration-none">
                  <img src="{{url('martley_web_asset/assets/img/icons/social/twitter.svg')}}" class="list-social-icon" alt="...">
                </a>
              </li>
              <li class="list-inline-item list-social-item">
                <a href="#!" class="text-decoration-none">
                  <img src="{{asset('martley_web_asset/assets/img/icons/social/pinterest.svg')}}" class="list-social-icon" alt="...">
                </a>
              </li>
            </ul>
