...
<head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{url('backend_asset/assets/images/favicon.ico')}}">

        <!-- third party css -->
        <link href="{{url('backend_asset/assets/css/vendor/jquery-jvectormap-1.2.2.css')}}" rel="stylesheet" type="text/css" />
        <!-- third party css end -->
